    ...
    return (
      <div className="p-6 flex items-center justify-center min-h-96">
        <div className="text-center">
          ...
          <h3 className="text-lg font-medium text-gray-900 mb-2">Error Loading Sales Orders</h3>
    ...
    <div className="p-6 space-y-6 max-w-full overflow-hidden">
      ...
      {orders.length === 0 ? (
        <div className="text-center py-12">
          ...
          <p className="text-gray-500 mb-4">Create your first sales order to get started</p>
          <button
            onClick={() => setShowCreateModal(true)}
            className="px-4 py-2 bg-primary text-white rounded-lg hover:bg-blue-700 transition-colors"
          >
              ...
              <div className="space-y-6">
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-900 break-words">{getCustomerName(selectedOrder.customerId)}</p>
                  </div>
                  <div>
